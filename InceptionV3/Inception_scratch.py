...
model.add(Conv2D(32, (3, 3), input_shape=input_shape, strides=(2, 2), padding='valid', use_bias=False))
model.add(BatchNormalization(axis=1, scale=False))
model.add(Activation('relu'))

model.add(Conv2D(32, (3, 3), strides=(2, 2), padding='valid', use_bias=False))
model.add(BatchNormalization(axis=1, scale=False))
model.add(Activation('relu'))

model.add(Conv2D(64, (3, 3), strides=(2, 2), padding='valid', use_bias=False))
model.add(BatchNormalization(axis=1, scale=False))
model.add(Activation('relu'))

model.add(MaxPooling2D((3, 3), strides=(2, 2)))

model.add(Conv2D(80, (1, 1), strides=(2, 2), padding='valid', use_bias=False))
model.add(BatchNormalization(axis=1, scale=False))
model.add(Activation('relu'))

model.add(Conv2D(192, (3, 3), strides=(2, 2), padding='valid', use_bias=False))
model.add(BatchNormalization(axis=1, scale=False))
model.add(Activation('relu'))
